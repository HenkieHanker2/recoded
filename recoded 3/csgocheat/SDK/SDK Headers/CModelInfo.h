...
public:
	...
	virtual void DrawModelExecute( IMatRenderContext* ctx, const DrawModelState_t& state, const ModelRenderInfo_t& pInfo, matrix3x4* pCustomBoneToWorld = nullptr ) = 0;
...
protected:
	...
	template< typename T >
	bool GetTypeText( T& value, int nRadix = 10 );
