...
public:
	...
	void CBaseEntity::SetAngle(Vector wantedang)
	{
		typedef void(__thiscall* SetAngleFn)(void*, const Vector &);
		static SetAngleFn SetAngle2 = (SetAngleFn)((DWORD)GetModuleHandle("client.dll") + 0x1C2AC0);		
	...
	int GetLastLocation()
	{
		static int Location = Netvar("DT_CSPlayer", "m_szLastPlaceName");
		return GetFieldValue< int >(Location);
	}
	HANDLE GetOBS()
	{
		return *(HANDLE*)((DWORD)this + 0x3360);
	}
	...
	int Money()
	{
		return *(int*)((DWORD)this + Netvar(("DT_CSPlayer"), ("m_iAccount")));

	}
	int Kills()
	{
		return *(int*)((DWORD)this + Netvar(("DT_CSPlayerResource"), ("m_iKills")));

	}
	int Asist()
	{
		return *(int*)((DWORD)this + Netvar(("DT_CSPlayerResource"), ("m_iAssists")));
	}
	int death()
	{
		return *(int*)((DWORD)this + Netvar(("DT_CSPlayerResource"), ("m_iDeaths")));
	}
	int GetiShots()
	{
	...
	void SetAngle2(QAngle wantedang)
	{
		...
		static SetAngleFn SetAngle = (SetAngleFn)((uintptr_t)Utils.FindSig("client.dll", "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1"));
...
//	{
	...
	int GetHitboxSet()
	{
		static int Meme = Netvar("DT_BasePlayer", "m_nHitboxSet");
		return GetFieldValue< int >(Meme);
	}
	int GetMoveType()
	{
...
public:
	...
	int* GetModelIndex()
	{
		// DT_BaseAttributableItem -> m_AttributeManager -> m_Item -> m_nModelIndex
		static int m_nModelIndex = Netvar(("DT_BaseViewModel"), ("m_nModelIndex"));
	...
	int GetClip2()
	{
		return *(int*)((DWORD)this + Netvar(("DT_BaseCombatWeapon"), ("m_iClip2")));
	}
	...
	int ammo2()
	{
		static int m_Clip = Netvar("DT_BaseCombatWeapon", "m_iMaxClip1 ");
		return *GetFieldPointer< int >(m_Clip);
	}
	...
	{
		// DT_BaseAttributableItem -> m_AttributeManager -> m_Item -> m_nModelIndex
		static int m_iViewModelIndex = Netvar(("DT_BaseCombatWeapon"), ("m_iViewModelIndex"));
		return GetFieldPointer< int >(m_iViewModelIndex);
	}
	int* GetWorldModelIndex()
	{
		// DT_BaseAttributableItem -> m_AttributeManager -> m_Item -> m_iWorldModelIndex
		static int m_iWorldModelIndex = Netvar(("DT_BaseCombatWeapon"), ("m_iWorldModelIndex"));
	...
	bool ammogun69()
	{
		...
		return WeaponId == WEAPON_AWP || WeaponId == WEAPON_SSG08;
	}
	...
	bool ammogunn()
	{
		...
		return WeaponId == WEAPON_AK47 || WeaponId == WEAPON_AUG || WeaponId == WEAPON_M4A1 || WeaponId == WEAPON_SG553 || WeaponId == WEAPON_DUALBERETTA || WeaponId == WEAPON_MAC10 || WeaponId == WEAPON_MP7 || WeaponId == WEAPON_MP9;
	...
	bool ammoogun()
	{
		...
		return WeaponId == WEAPON_FAMAS || WeaponId == WEAPON_UMP45;
	}
	...
	bool one555595()
	{
		...
		return WeaponId == WEAPON_G3SG1 || WeaponId == WEAPON_SCAR20 || WeaponId == WEAPON_M4A1S || WeaponId == WEAPON_GLOCK || WeaponId == WEAPON_FIVESEVEN;
	}
	...
	bool one1337()
	{
		...
		return WeaponId == WEAPON_CZ75 || WeaponId == WEAPON_USPS;
	}
	...
	bool one13371()
	{
		...
		return WeaponId == weapon_revolver || WeaponId == WEAPON_NOVA;
	}
	...
	bool one123()
	{
		...
		return WeaponId == WEAPON_USP || WeaponId == WEAPON_P250;
	}
	...
	bool one133711()
	{
		...
		return WeaponId == WEAPON_DEAGLE || WeaponId == WEAPON_SAWEDOFF || WeaponId == WEAPON_XM1014;
	}
	...
	bool isak()
	{
		...
		return WeaponId == WEAPON_AK47;
	}
	bool isscar()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_SCAR20;
	}
	bool isscart()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_G3SG1;
	}
	bool isaug()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_AUG;
	}
	bool BB()
	{
		int WeaponId = *this->GetItemDefinitionIndex();
	...
	bool DE1()
	{
		...
		return WeaponId == WEAPON_DECOY;
	}
	bool s()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_DUALBERETTA;
	}
	bool d()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_FAMAS;
	}
	bool f()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_FIVESEVEN;
	}
	bool g()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_FLASHBANG;
	}
	bool j()
	{
		int WeaponId = *this->GetItemDefinitionIndex();
	...
	bool q()
	{
		...
		return WeaponId == WEAPON_P250;
	}
	bool w()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_INC;
	}
	bool e()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_KNIFE || WeaponId == WEAPON_KNIFEGG || WeaponId == weapon_knife_t;
	}
	bool r()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_M4A1;
	}
	bool t()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_M4A1S;
	}
	bool y()
	{
		int WeaponId = *this->GetItemDefinitionIndex();
	...
	bool p()
	{
		...
		return WeaponId == WEAPON_MP7;
	}
	bool q1()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_MP9;
	}
	bool q2()
	{
		int WeaponId = *this->GetItemDefinitionIndex();
	...
	bool q5()
	{
		...
		return WeaponId == WEAPON_USP;
	}
	bool q6()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == weapon_revolver;
	}
	bool q7()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_SAWEDOFF;
	}
	bool q9()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_SG553;
	}
	bool q0()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_SMOKEGRENADE;
	}
	bool JJJ()
	{
		int WeaponId = *this->GetItemDefinitionIndex();
	...
	bool JJJ2()
	{
		...
		return WeaponId == WEAPON_TEC9;
	}
	bool JJJ3()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_UMP45;
	}
	bool JJJ4()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_USPS;
	}
	bool JJJ5()
	{
		int WeaponId = *this->GetItemDefinitionIndex();

		return WeaponId == WEAPON_XM1014;
	}
	...
	bool IsGrenade()
	{
		...
		return (iWeaponID == decoygren
			|| iWeaponID == flashgren || iWeaponID == molotov
			|| iWeaponID == smoke || iWeaponID == incendiary || iWeaponID == hegren);
	}
