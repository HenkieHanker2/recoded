...
public:
	static bool Misc::FindBestSide(CBaseEntity *pLocalPlayer, float flDistance, CInput::CUserCmd* pCmd, QAngle& qAngle)
	{
		float closest_distance = flDistance;

		QAngle startAngle = qAngle;

		startAngle.x = 0.f;

		Vector eyePos = pLocalPlayer->GetEyePosition();
		...
		trace_t trace;
			...
			AngleVectors(rotateAngle, &forward);

			Vector vEnd = forward * (flDistance * cos(sideArray[i])) + pLocalPlayer->GetEyePosition();
	...
	static void ClantagChanger()
	{
		if (!Interfaces.pEngine->IsConnected() || !Interfaces.pEngine->IsInGame())
			return;
		if (Options.Visuals.Infobox.bClantag)
		{
			...
			switch (value) 
			{
			case 0: SetClanTag("f", "foothook"); break;
			case 1: SetClanTag("fe", "foothook"); break;
			case 2: SetClanTag("foo", "foothook"); break;
			case 3: SetClanTag("foot", "foothook"); break;
			case 4: SetClanTag("footh", "foothook"); break;
			case 5: SetClanTag("footho", "foothook"); break;
			case 6: SetClanTag("foothoo", "foothook"); break;
			case 7: SetClanTag("foothook", "foothook"); break;
			case 8: SetClanTag("foothoo", "foothook"); break;
			case 9: SetClanTag("footho", "foothook"); break;
			case 10: SetClanTag("footh", "foothook"); break;
			case 11: SetClanTag("foot", "foothook"); break;
			case 12: SetClanTag("foo", "foothook"); break;
			case 13: SetClanTag("fo", "foothook"); break;
			case 14: SetClanTag("f", "foothook"); break;
	...
	static inline void CrossProduct(const Vector& vecA, const Vector& vecB, Vector& vecResult)
	{
