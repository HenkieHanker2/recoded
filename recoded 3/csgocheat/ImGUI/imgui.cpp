...
ImGuiStyle::ImGuiStyle()
{
	...
	WindowRounding = 0.0f;
    FrameRounding = 0.0f;        // Radius of window corners rounding. Set to 0.0f to have rectangular windows
    ...
    ScrollbarRounding       = 2.3f;             // Radius of grab corners rounding for scrollbar
	...
	Colors[ImGuiCol_PopupBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
	...
	Colors[ImGuiCol_TitleBg] = ImVec4(0.75f, 0.11f, 0.22f, 1.00f);
	Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.75f, 0.11f, 0.22f, 1.00f);
	Colors[ImGuiCol_TitleBgActive] = ImVec4(0.75f, 0.11f, 0.22f, 1.00f);
	Colors[ImGuiCol_MenuBarBg] = ImVec4(0.75f, 0.11f, 0.22f, 1.00f);
Colors[ImGuiCol_ScrollbarBg] = ImVec4(0.45f, 0.45f, 0.45f, 1.00f);
Colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.65f, 0.65f, 0.65f, 1.00f);
	...
	Colors[ImGuiCol_ComboBg] = ImVec4(0.47f, 0.46f, 0.48f, 1.00f);
	Colors[ImGuiCol_CheckMark] = ImVec4(0.67f, 0.82f, 0.12f, 1.00f);
	Colors[ImGuiCol_SliderGrab] = ImVec4(0.67f, 0.82f, 0.12f, 1.00f);
	Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.67f, 0.82f, 0.12f, 1.00f);
Colors[ImGuiCol_Button] = ImVec4(0.10f, 0.10f, 0.10f, 0.98f);
	Colors[ImGuiCol_ButtonHovered] = ImVec4(0.13f, 0.13f, 0.13f, 1.00f);
	Colors[ImGuiCol_ButtonActive] = ImVec4(0.15f, 0.15f, 0.15f, 1.00f);
	Colors[ImGuiCol_Header] = ImVec4(0.10f, 0.10f, 0.10f, 0.00f);
Colors[ImGuiCol_HeaderHovered] = ImVec4(0.38f, 0.37f, 0.38f, 1.00f);
Colors[ImGuiCol_HeaderActive] = ImVec4(0.46f, 0.44f, 0.46f, 1.00f);
	Colors[ImGuiCol_Separator] = ImVec4(0.75f, 0.10f, 0.24f, 1.00f);
	Colors[ImGuiCol_SeparatorHovered] = ImVec4(0.51f, 0.11f, 0.17f, 1.00f);
	Colors[ImGuiCol_SeparatorActive] = ImVec4(0.46f, 0.44f, 0.46f, 1.00f);
	Colors[ImGuiCol_ResizeGrip] = ImVec4(1.00f, 1.00f, 1.00f, 0.30f);
	Colors[ImGuiCol_ResizeGripHovered] = ImVec4(1.00f, 1.00f, 1.00f, 0.60f);
Colors[ImGuiCol_ResizeGripActive] = ImVec4(1.00f, 1.00f, 1.00f, 0.90f);
Colors[ImGuiCol_CloseButton] = ImVec4(1.00f, 0.10f, 0.24f, 1.00f);
Colors[ImGuiCol_CloseButtonHovered] = ImVec4(1.00f, 0.10f, 0.24f, 1.00f);
Colors[ImGuiCol_CloseButtonActive] = ImVec4(1.00f, 0.10f, 0.24f, 1.00f);
...
Colors[ImGuiCol_ModalWindowDarkening] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
}
...
bool ImGui::SliderFloat(const char* label, float* v, float v_min, float v_max, const char* display_format, float power)
{
    ...
    const ImVec2 label_size = CalcTextSize(label, NULL, true);
    const ImRect frame_bb(window->DC.CursorPos, window->DC.CursorPos + ImVec2(w, label_size.y + style.FramePadding.y*.5f));
...
bool ImGui::Combo(const char* label, int* current_item, bool (*items_getter)(void*, int, const char**), void* data, int items_count, int height_in_items)
{
 ...
 //   const ImGuiStyle& style = g.Style;
 //   const ImGuiID id = window->GetID(label);
	//const float w = 174;//CalcItemWidth();
 ...
 //   //RenderCollapseTriangle(ImVec2(frame_bb.Max.x-arrow_size, frame_bb.Min.y) + style.FramePadding, true);
	...
	const ImRect value_bb(frame_bb.Min, frame_bb.Max - ImVec2(arrow_size, 0.0f));
	RenderFrame(frame_bb.Min, frame_bb.Max, GetColorU32(ImGuiCol_FrameBg), true, style.FrameRounding);
	RenderFrame(ImVec2(frame_bb.Max.x - arrow_size, frame_bb.Min.y), frame_bb.Max, GetColorU32(popup_open || hovered ? ImGuiCol_ButtonHovered : ImGuiCol_Button), true, style.FrameRounding); // FIXME-ROUNDING (THIS IS COMBO ARROW)
	RenderCollapseTriangle(ImVec2(frame_bb.Max.x - arrow_size, frame_bb.Min.y) + style.FramePadding, true);
    ...
    if (!(flags & ImGuiColorEditFlags_NoSmallPreview))
    {
        ...
        if (ColorButton("##ColorButton", col_v4, flags))
        {
            if (!(flags & ImGuiColorEditFlags_NoPicker))
            {
                ...
                OpenPopup("picker");
                SetNextWindowPos(window->DC.LastItemRect.GetBL() + ImVec2(-4,style.ItemSpacing.y));
            }
        }
        if (!(flags & ImGuiColorEditFlags_NoOptions) && IsItemHovered() && IsMouseClicked(1))
            OpenPopup("context");
