...
public:
	...
	void Hook()
	{
		...
		Font_ESP3 = Interfaces.pSurface->Create_Font();
		...
		*/
		...
		Interfaces.pSurface->SetFontGlyphSet( Font_ESP, "C:\\Windows\\Fonts\\Verdana.ttf", 10, 50, 0, 0,  FONTFLAG_OUTLINE);
		...
		Interfaces.pSurface->SetFontGlyphSet(Font_ESP3, "Counter-Strike", 30, 800, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
		...
		CreateDirectory("C:\\foothookcfgs", NULL);
